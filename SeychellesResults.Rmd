...
## Datasets summary
Most of the blue carbon literature in the WIO focuses on plant carbon stocks (X studies; Fig. Xb); with X% of these publications providing aboveground biomass (e.g., ), X% calculating belowground biomass (e.g., ), X% testing species- or site-specific allometric models (e.g., ), and X% reporting wood densities (e.g. ). 

Despite most of the blue carbon stocks are stored within the coastal sediments, only X% of the XX studies included data on soil carbon stock (Fig. Xb). ____ percent of them report carbon stocks values on shallow soil cores (< X cm depth; e.g., Hemminga1994; Kristensen2008), while X% provide carbon estimates along deeper soil profiles (> X cm depth; e.g. Langat2014; Gress2017). Soil carbon content in the region is usually  calculated via the Walkley-Black Method (X%; e.g., Malgahaes2019), loss-on-ignition (LOI; %; e.g., Lyimo2002), or an elemental CN analyser (X%; e.g., Middelburg1996). Research that included soil carbon accretion rates comprised small component of the literature (X%) and they were generally focused on detecting Holocene sea-level changes using radiocarbon or Pb210 age dating on sediment cores (e.g., Punwong2013, Woodoffre2015). 
